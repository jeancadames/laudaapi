...
return new class extends Migration
{
    ...
    {
        Schema::create('transformation_implementation_capability_executions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('transformation_implementation_capability_executions');
    }
};
