    ...
    extends TestCase
{
    ...
    public function test_admin_moves_exact_functionally_ready_v2_to_ready_for_commercial_without_commercial_artifacts_or_execution(): void
    {
        $context =
        ...
        /*
         * ==========================================================
         * F6-G7-A · READY-FOR-COMMERCIAL BLOCKED BEFORE CLOSURE
         * ==========================================================
         */

        $readyForCommercialUrl =
            route(
        ...
        $readySpecificEventsBeforePrematureAttempt =
            DB::table(
                'transformation_implementation_request_events'
            )
                ->where(
        ...
        /*
         * Admin read model must not expose the gate yet.
         */
        $this
            ->actingAs(
                $admin
            ...
            ->assertInertia(
                fn (Assert $page) =>
                    $page
                        ...
                        ->where(
                            'actions.can_mark_ready_for_commercial',
                            false
                        )
                        ->where(
                            'actions.ready_for_commercial_endpoint',
                            null
                        )
            );

        /*
         * Crafted direct POST is also blocked by the domain.
         */
        $this
            ->actingAs(
                $admin
        ...
        /*
         * ==========================================================
         * F6-G7-B · PREPARE REAL READY-FOR-COMMERCIAL GATE
         * ==========================================================
         */
        ...
        /*
         * The dedicated gate becomes visible only now.
         */
        $this
            ->actingAs(
                $admin
            ...
            ->assertInertia(
                fn (Assert $page) =>
                    $page
                        ...
                        ->where(
                            'ready_for_commercial_context.definition_id',
                            (int) $v2->id
                        )
                        ->where(
                            'ready_for_commercial_context.definition_version',
                            2
                        )
                        ->where(
                            'ready_for_commercial_context.definition_status',
                            TransformationImplementationDefinition::STATUS_READY
                        )
                        ->where(
                            'ready_for_commercial_context.definition_ready',
                            true
                        )
                        ->where(
                            'ready_for_commercial_context.can_mark_ready_for_commercial',
                            true
                        )
                        ->where(
                            'actions.can_mark_ready_for_commercial',
        ...
        /*
         * Tenant cannot call LAUDA Admin gate.
         */
        $this
            ->actingAs(
                $tenant
        ...
        /*
         * Definitions must remain fully immutable during Request transition.
         */
        $v1BeforeReadyForCommercial =
            (array) DB::table(
                'transformation_implementation_definitions'
            )
                ->where(
        ...
        $definitionAgreedAtBeforeReadyForCommercial =
            $implementationRequest
                ->definition_agreed_at
                ?->toISOString();

        $genericReadyTransitionCountBefore =
            DB::table(
                'transformation_implementation_request_events'
            )
                ->where(
        ...
        $readyForCommercialAuditMaxIdBefore =
            Schema::hasTable(
                'audit_logs'
            )
                ? (int) (
        ...
        /*
         * ==========================================================
         * REAL ADMIN HTTP READY-FOR-COMMERCIAL TRANSITION
         * ==========================================================
         */
        ...
        /*
         * Request changes exactly to terminal functional status.
         */
        $this->assertSame(
            TransformationImplementationRequestContract::STATUS_READY_FOR_COMMERCIAL,
            $implementationRequest->status
        ...
        /*
         * Both Definitions remain byte-for-byte immutable.
         */
        $this->assertSame(
            $v1BeforeReadyForCommercial,
            (array) DB::table(
                ...
                ->first(),
            'V1 fue alterada al pasar Request a ready_for_commercial.'
        );
        ...
        $this->assertSame(
            ...
            (array) DB::table(
                ...
                ->first(),
            'V2 fue alterada al pasar Request a ready_for_commercial.'
        );
        ...
        /*
         * Exactly one generic lifecycle transition.
         */
        $genericReadyTransitions =
            DB::table(
                'transformation_implementation_request_events'
            )
                ->where(
        ...
        $this->assertCount(
            $genericReadyTransitionCountBefore + 1,
            $genericReadyTransitions
        );

        $genericReadyTransition =
            $genericReadyTransitions->last();
        ...
        $this->assertSame(
            'lauda_admin',
            $genericReadyTransition->actor_type
        );

        $this->assertSame(
            (int) $admin->id,
            (int) $genericReadyTransition->actor_user_id
        );

        /*
         * Exactly one version-specific ready-for-commercial event.
         */
        $specificReadyEvents =
            DB::table(
                'transformation_implementation_request_events'
        ...
        $this->assertCount(
            $specificReadyEventCountBefore + 1,
            $specificReadyEvents
        );

        $specificReadyEvent =
            $specificReadyEvents->last();
        ...
        $this->assertSame(
            TransformationImplementationRequestContract::STATUS_DEFINITION_AGREED,
            $specificReadyEvent->from_status
        );

        $this->assertSame(
            TransformationImplementationRequestContract::STATUS_READY_FOR_COMMERCIAL,
            $specificReadyEvent->to_status
        );

        $this->assertSame(
            'lauda_admin',
            $specificReadyEvent->actor_type
        );

        $this->assertSame(
            (int) $admin->id,
            (int) $specificReadyEvent->actor_user_id
        );

        $specificReadyMetadata =
            json_decode(
                (string) (
                    $specificReadyEvent->metadata
                    ?? ''
                ),
                true,
                512,
        ...
        foreach ([
            ...
            $this->assertFalse(
                ...
                'Boundary comercial inesperado: '.$boundaryKey
            );
        }

        /*
         * Specific request audit pins exact V2.
         */
        if (
            Schema::hasTable(
                'audit_logs'
            ...
            foreach ([
                ...
                $this->assertFalse(
                    ...
                    'Boundary audit inesperado: '.$boundaryKey
                );
            }
        }
        ...
        /*
         * ==========================================================
         * ADMIN READ MODEL AFTER READY-FOR-COMMERCIAL
         * ==========================================================
         */
            ...
            ->assertInertia(
                fn (Assert $page) =>
                    $page
                        ...
                        ->where(
                            'ready_for_commercial_context.request_status',
                            TransformationImplementationRequestContract::STATUS_READY_FOR_COMMERCIAL
                        )
                        ->where(
                            'ready_for_commercial_context.ready_for_commercial_at',
                            $implementationRequest
        ...
        /*
         * Tenant keeps safe read-only access to exact V2.
         */
        $this
            ->actingAs(
                $tenant
        ...
        $specificReadyCountBeforeReplay =
            DB::table(
                'transformation_implementation_request_events'
            )
                ->where(
        ...
        $this->assertSame(
            ...
            (array) DB::table(
                ...
                ->first(),
            'Replay modificó Request ready_for_commercial.'
        );
        ...
        /*
         * No V3 or downstream execution/commercial side effects.
         */
        $this->assertSame(
            2,
            TransformationImplementationDefinition::query()
