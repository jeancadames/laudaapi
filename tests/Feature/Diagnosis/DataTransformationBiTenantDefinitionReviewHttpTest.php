...
final class DataTransformationBiTenantDefinitionReviewHttpTest
    extends TestCase
{
     ...
     * }
     */
    public function test_tenant_admin_can_read_presented_request_scoped_definition_safely(): void
    {
        /*
         * ==========================================================
         * 1. PRIMARY TENANT
        ...
        /*
         * ==========================================================
         * 2. REAL REQUEST LIFECYCLE TO DEFINITION_PREPARATION
         * ==========================================================
         */
        ...
        $implementationRequest =
            $requests
                ->transitionByLauda(
                    ...
                    $admin,
                    'F6B2 · Preparación de Definition.'
                );

        /*
         * ==========================================================
         * 3. CREATE + GENERATE REQUEST-SCOPED DEFINITION
         * ==========================================================
         */
        ...
        $implementationRequest =
            $tenantReview
                ->submit(
                    ...
                    $definition,
                    $admin,
                    'F6B2 · Definition BI enviada a revisión.'
                );
        ...
        /*
         * ==========================================================
         * 6. FOREIGN TENANT FIXTURE
         * ==========================================================
         *
         * Tiene su propio Company/Assessment/Plan.
         * No debe poder recibir la Definition del tenant primario.
         */
        ...
        $foreignCompany =
            $foreignContext['company'];

        /*
         * ==========================================================
         * 7. NON-ADMIN TENANT FIXTURE
         * ==========================================================
         */
        ...
        $draftRequest =
            $requests
                ->requestFromTenantAdmin(
                    $draftContext['company'],
                    $draftContext['assessment'],
                    $draftContext['plan'],
                    $draftContext['phase_capability'],
                    $draftTenant,
                    'F6B2 · Draft safety request.'
                );
        ...
        $this->assertSame(
            TransformationImplementationDefinition::STATUS_DRAFT,
            $draftDefinition->status
        );

        /*
         * ==========================================================
         * 9. READ-ONLY BASELINE
         * ==========================================================
         */
        ...
        /*
         * ==========================================================
         * 10. CORRECT TENANT ADMIN CAN READ EXACT DEFINITION
         * ==========================================================
         */
            ...
            ->assertInertia(
                fn (Assert $page) =>
                    $page
                        ...
                        ->where(
                            'implementation_request.definition_review.scope.scope_mode',
                            'single_capability'
                        )
                        ->where(
                            'implementation_request.definition_review.scope.capability_key',
                            'data_transformation_bi'
                        )
                        ->where(
                            'implementation_request.definition_review.scope.phases',
                            $expectedScopePhases
                        )
                        ->where(
                            'implementation_request.definition_review.deliverables',
                            $expectedDeliverables
                        )
                        ->where(
                            'implementation_request.definition_review.dependencies',
                            $expectedDependencies
                        )
                        ->where(
                            'implementation_request.definition_review.responsibilities.party_assignment_status',
                            'confirmed'
                        )
                        ->where(
                            'implementation_request.definition_review.responsibilities.assignments',
                            $expectedAssignments
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.completed',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.confirmations.scope_confirmed',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.confirmations.deliverables_confirmed',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.confirmations.dependencies_confirmed',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.confirmations.inputs_validated',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.confirmations.accesses_validated',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.confirmations.responsibilities_confirmed',
                            true
                        )
                        ->where(
                            'implementation_request.definition_review.human_review.reviewed_at',
                            $definition
                                ->reviewed_at
                                ?->format(
                                    'd/m/Y H:i'
                        ...
                        ->where(
                            'implementation_request.definition_review.submitted_at',
                            $implementationRequest
                        ...
                        ->missing(
                            'implementation_request.definition_review.source_snapshot'
                        )
                        ->missing(
                            'implementation_request.definition_review.internal_notes'
                        )
                        ->missing(
                            'implementation_request.definition_review.created_by_user_id'
                        )
                        ->missing(
                            'implementation_request.definition_review.updated_by_user_id'
                        )
                        ->missing(
                            'implementation_request.definition_review.reviewed_by_user_id'
                        )
            );

        /*
         * ==========================================================
         * 11. FOREIGN TENANT CANNOT SEE PRIMARY DEFINITION
         * ==========================================================
         */
            ...
            ->assertInertia(
                fn (Assert $page) =>
                    $page
                        ...
                        ->where(
                            'company.id',
                            (int) $foreignCompany->id
                        )
                        ->where(
                            'implementation_request.definition_review',
                            null
                        )
            );
        ...
        /*
         * ==========================================================
         * 12. SUBSCRIBER NON-ADMIN IS BLOCKED
         * ==========================================================
         */
        ...
        /*
         * ==========================================================
         * 13. DRAFT DEFINITION IS NOT TENANT VISIBLE
         * ==========================================================
         */
        ...
        foreach (
            ...
            $this->assertSame(
                ...
                'GET produjo una mutación no permitida en '
                .$table
            );
        }
        ...
        /*
         * ==========================================================
         * 15. FUNCTIONAL BOUNDARY REMAINS CLOSED
         * ==========================================================
         */
