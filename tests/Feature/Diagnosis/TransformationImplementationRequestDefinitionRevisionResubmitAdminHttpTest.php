...
final class TransformationImplementationRequestDefinitionRevisionResubmitAdminHttpTest
    extends TestCase
{
    ...
    public function test_admin_resubmits_only_latest_reviewed_v2_and_tenant_receives_exact_version(): void
    {
        $context =
        ...
        /*
         * ==========================================================
         * ADMIN CANNOT RESUBMIT WHILE ALREADY AWAITING TENANT
         * ==========================================================
         */
