...
final class TransformationImplementationRequestDefinitionRevisionFunctionalEditAdminHttpTest
    extends TestCase
{
    ...
    public function test_admin_edits_only_v2_functionally_and_stale_v1_is_immutable(): void
    {
        $context =
