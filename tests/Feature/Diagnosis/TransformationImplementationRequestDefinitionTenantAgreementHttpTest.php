...
final class TransformationImplementationRequestDefinitionTenantAgreementHttpTest
    extends TestCase
{
    ...
    public function test_tenant_agrees_exact_latest_v2_without_finalization_or_downstream_side_effects(): void
    {
        $context =
        ...
        /*
         * Replay through HTTP is blocked because there is no longer
         * an awaiting_tenant_review request to resolve.
         */
        $specificEventCountBeforeReplay =
            DB::table(
                'transformation_implementation_request_events'
            )
                ->where(
        ...
        $specificAuditCountBeforeReplay =
            Schema::hasTable(
                'audit_logs'
            )
                ? DB::table(
        ...
        /*
         * Definitions remain immutable after replay too.
         */
        $this->assertSame(
            $v1BeforeAgreement,
            (array) DB::table(
        ...
        /*
         * No activation/commercial/execution/subscription side effects.
         */
        foreach (
            $guards
            as $table => $before
