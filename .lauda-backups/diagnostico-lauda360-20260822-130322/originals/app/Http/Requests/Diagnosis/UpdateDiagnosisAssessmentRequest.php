...
class UpdateDiagnosisAssessmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'current_step' => ['required', 'integer', 'between:1,' . config('lauda360_diagnosis.steps', 11)],
        ];
    }
        ...
        return [
            function (Validator $validator): void {
                ...
                if ($unexpectedAnswers !== []) {
                    $validator->errors()->add('answers', 'Se recibieron preguntas que no pertenecen a la versión vigente del diagnóstico.');
                }
