...
const ecosystemBenefits = [
    {
        ...
        desc: 'Desde una conversación, oportunidad o pedido web hasta una operación real.',
        icon: MessageCircle,
        color: '#EC4899',
    },
    {
        title: 'Operación centralizada',
        desc: 'POS concentra ventas, inventario, cobros, facturación y despacho.',
        icon: Store,
        color: '#22C55E',
    },
    {
        title: 'Fiscal sin reprocesos',
        desc: 'e-CF recibe la operación fiscal, firma XML y responde ante DGII.',
        icon: FileText,
        color: '#F59E0B',
    },
    {
        title: 'Trazabilidad completa',
        desc: 'Status observa eventos, salud operativa y disponibilidad del ecosistema.',
        icon: Activity,
        color: '#3B82F6',
    },
]
...
const useCases = [
    {
        title: 'Lead social a venta facturada',
        desc: 'Una conversación entra por Social, CRM la convierte en oportunidad, POS opera la venta y e-CF genera la respuesta fiscal.',
    },
    {
        title: 'Pedido ecommerce a entrega',
        desc: 'El pedido web entra al flujo operativo sin duplicar inventario, facturación ni despacho.',
    },
    {
        title: 'Compras a cumplimiento',
        desc: 'BYS organiza compras y gastos, e-CF valida documentos y Cumplimiento prepara el control fiscal.',
    },
]

const responsibilityRules = [
    'CRM no factura ni rebaja inventario.',
    'Ecommerce no crea CxC ni conduce directamente.',
    'Delivery no decide si una venta existe.',
    'e-CF no opera pedidos ni almacén.',
    'Status observa, no altera operaciones.',
]
...
<template>
    ...
    <div class="min-h-screen scroll-smooth bg-[#F4F4F6] text-[#0B0B12] antialiased">
        <!-- ===================== NAV ===================== -->
        <nav class="sticky top-0 z-50 border-b border-black/5 bg-[#F4F4F6]/88 backdrop-blur-xl">
            <div class="mx-auto flex h-[76px] max-w-none items-center gap-8 px-8 2xl:px-10">
                ...
                <Button as-child class="ml-auto gap-2 rounded-xl bg-[#0B0B12] px-6 py-6 text-white hover:bg-black lg:ml-0">
                    <Link href="/login">
                        <User class="h-4 w-4" />
                        Iniciar sesión
                    </Link>
        ...
        <!-- ===================== HERO / ECOSISTEMA ===================== -->
        <section id="ecosistema" class="mx-auto max-w-none scroll-mt-28 px-6 pt-10 2xl:px-8">
            <div class="grid items-center gap-6 xl:grid-cols-[450px_minmax(0,1fr)] 2xl:grid-cols-[470px_minmax(0,1fr)]">
                <div class="max-w-[455px]">
                    ...
                    <div class="mt-8 flex gap-3">
                        <Button as-child class="gap-2 rounded-xl bg-[#F5333C] px-6 py-6 text-white hover:bg-[#d92730]">
                            <a href="#soluciones">
                                Ver soluciones
                        ...
                        <Button as-child variant="outline" class="rounded-xl border-black/10 bg-white px-6 py-6 hover:bg-[#FAFAFA]">
                            <a href="#contacto">
                                Solicitar demo
                            </a>
                        </Button>
        ...
        <!-- ===================== FLUJOS ===================== -->
        <section id="flujos" class="mx-auto max-w-none scroll-mt-28 px-8 py-10 2xl:px-10">
        ...
        <!-- ===================== SOLUCIONES ===================== -->
        <section id="soluciones" class="mx-auto max-w-none scroll-mt-28 px-8 pb-10 2xl:px-10">
            <div class="rounded-[28px] bg-white p-8 shadow-xl shadow-black/[0.03] lg:p-10">
                <div class="grid gap-8 lg:grid-cols-[360px_1fr]">
                    <div>
                        <p class="text-[11px] font-black uppercase tracking-[0.28em] text-[#F5333C]">
                            Soluciones conectadas
                        </p>

                        <h2 class="mt-4 text-4xl font-extrabold tracking-tight">
                            Cada ambiente resuelve una parte del negocio.
                        </h2>

                        <p class="mt-4 text-[15px] leading-7 text-[#6B7280]">
                            LaudaAPI no presenta apps aisladas. Presenta un ecosistema donde cada producto tiene una responsabilidad clara y se conecta con los demás.
                        </p>
                    </div>

                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <article
                            v-for="benefit in ecosystemBenefits"
                            :key="benefit.title"
                            class="rounded-3xl border border-black/5 bg-[#F8F8FA] p-5"
                        >
                            <span
                                class="grid h-11 w-11 place-items-center rounded-xl"
                                :style="{ background: benefit.color + '1a' }"
                            >
                                <component
                                    :is="benefit.icon"
                                    class="h-5 w-5"
                            ...
                            <h3 class="mt-5 text-[17px] font-black">
                                {{ benefit.title }}
                            </h3>

                            <p class="mt-2 text-[13px] leading-6 text-[#6B7280]">
                                {{ benefit.desc }}
                            </p>
                        </article>
                    </div>
        ...
        <!-- ===================== CASOS DE USO ===================== -->
        <section class="mx-auto max-w-none px-8 pb-10 2xl:px-10">
            <div class="grid gap-5 lg:grid-cols-[1fr_1fr]">
                <div class="rounded-[28px] bg-[#0B0B12] p-8 text-white shadow-2xl shadow-slate-950/20 lg:p-10">
                    <p class="text-[11px] font-black uppercase tracking-[0.28em] text-[#F5333C]">
                        Casos reales
                    </p>

                    <h2 class="mt-4 text-4xl font-extrabold tracking-tight">
                        Recorridos completos, no pantallas separadas.
                    </h2>

                    <p class="mt-4 text-[15px] leading-7 text-white/60">
                        La propuesta visual deja claro que LaudaAPI conecta procesos de punta a punta: captación, conversión, operación, fiscal, entrega y monitoreo.
                    </p>
                ...
                <div class="rounded-[28px] bg-white p-8 shadow-xl shadow-black/[0.03] lg:p-10">
                    ...
                    <h2 class="mt-4 text-4xl font-extrabold tracking-tight">
                        Cada app hace su parte. Ninguna duplica a otra.
                    </h2>

                    <p class="mt-4 text-[15px] leading-7 text-[#6B7280]">
                        Esta separación evita errores operativos y mantiene una fuente de verdad para ventas, fiscal, delivery, compras y monitoreo.
                    </p>

                    <div class="mt-8 grid gap-3">
                        <div
                            v-for="rule in responsibilityRules"
                            :key="rule"
                            class="flex items-start gap-3 rounded-2xl border border-black/5 bg-[#F8F8FA] p-4"
                        >
                            <span class="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-full bg-[#F5333C]/10 text-xs font-black text-[#F5333C]">
                                ✓
                            </span>

                            <p class="text-sm font-semibold leading-6 text-[#4B5563]">
                                {{ rule }}
                            </p>
                        </div>
                    </div>
        ...
        <!-- ===================== CONTACTO ===================== -->
        <section id="contacto" class="mx-auto max-w-none scroll-mt-28 px-8 pb-14 pt-2 2xl:px-10">
            <div class="rounded-[28px] bg-[#0B0B12] p-8 text-white shadow-2xl shadow-slate-950/20 lg:p-10">
                <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
                    <div>
                        ...
                        <h2 class="mt-4 max-w-3xl text-4xl font-extrabold tracking-tight lg:text-5xl">
                            Hablemos de cómo conectar tu operación.
                        </h2>

                        <p class="mt-5 max-w-2xl text-[15px] leading-7 text-white/60">
                            Cuéntanos qué estás buscando conectar: ventas, POS, e-CF, delivery, compras, cumplimiento, bancos o monitoreo. Te ayudamos a aterrizar el flujo correcto.
                        </p>
                        ...
                        <div class="mt-8 grid gap-4 sm:grid-cols-2">
                            <div class="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                                ...
                                <a
                                    ...
                                    class="mt-2 block text-sm text-white/60 hover:text-white"
                                >
                            ...
                            <div class="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                                ...
                                <p class="mt-2 text-sm leading-6 text-white/60">
                                    CRM, POS, e-CF, Status, Cumplimiento, BYS, Bancos y Delivery.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form
                        class="rounded-[24px] border border-white/10 bg-white p-6 text-[#0B0B12] shadow-2xl shadow-black/20"
                        @submit.prevent="submitContact"
                    >
                        <div class="grid gap-4 md:grid-cols-2">
                            <div>
                                <label class="text-xs font-black uppercase tracking-[0.16em] text-[#6B7280]">
                                    Nombre
                                </label>
                                <input
                                    ...
                                    type="text"
                                    name="name"
                                    class="mt-2 w-full rounded-xl border border-black/10 bg-[#F8F8FA] px-4 py-3 text-sm outline-none transition focus:border-[#F5333C] focus:bg-white"
                                    placeholder="Tu nombre"
                                    required
                                />
                                <p v-if="contactForm.errors.name" class="mt-1 text-xs font-semibold text-red-600">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p v-if="contactForm.errors.email" class="mt-1 text-xs font-semibold text-red-600">
                            ...
                            <div>
                                ...
                                />
                                <p v-if="contactForm.errors.company" class="mt-1 text-xs font-semibold text-red-600">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="+1 809..."
                                />
                                <p v-if="contactForm.errors.phone" class="mt-1 text-xs font-semibold text-red-600">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea
                                ...
                                name="message"
                                rows="5"
                                class="mt-2 w-full resize-none rounded-xl border border-black/10 bg-[#F8F8FA] px-4 py-3 text-sm outline-none transition focus:border-[#F5333C] focus:bg-white"
                                placeholder="Cuéntanos qué necesitas conectar..."
                                required
                            />
                            <p v-if="contactForm.errors.message" class="mt-1 text-xs font-semibold text-red-600">
                        ...
                        <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <Button
                                type="submit"
                                class="rounded-xl bg-[#F5333C] px-6 py-6 text-white hover:bg-[#d92730]"
