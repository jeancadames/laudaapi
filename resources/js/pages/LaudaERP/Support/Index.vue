...
<template>
    ...
    <Head title="Soporte (ERP)" />

    <ErpLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-4 p-4">
            <!-- Header + filtros -->
            <SectionCard title="Soporte" description="Preguntas frecuentes y tickets de soporte (ERP)">
            ...
            <!-- Tickets -->
            <SectionCard title="Mis tickets" description="Historial de solicitudes a soporte (ERP)">
                        ...
                        <tbody>
                            <tr v-for="t in filteredTickets" :key="t.id" class="border-t">
                                ...
                                <td class="px-3 py-2 text-right">
                                    <Button size="sm" variant="outline" @click="router.get(`/erp/support/tickets/${t.id}`)">
                                        Ver
                                    </Button>
                                </td>
                            </tr>
