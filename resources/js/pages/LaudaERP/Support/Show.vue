...
function send() {
    form.post(`/erp/support/tickets/${props.ticket.id}/messages`, {
        preserveScroll: true,
...
<template>
    ...
    <Head :title="`Ticket ${props.ticket.number} (ERP)`" />
            ...
            <SectionCard :title="`${props.ticket.number} • ${props.ticket.subject}`" description="Conversación del ticket">
                ...
                <div class="mt-4 space-y-2">
                    ...
                    <div class="flex justify-end gap-2">
                        <Link class="self-center text-sm underline" href="/erp/support">Volver</Link>
