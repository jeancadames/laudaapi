...
<template>
    ...
    <div class="min-h-screen bg-muted/20">
        ...
        <main class="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
            ...
            <DigitalDiagnosisWizard :initial-answers="assessment.answers ?? {}" :initial-notes="assessment.notes ?? {}" :initial-step="assessment.current_step ?? 1" :read-only="isReadOnly" @save="saveDiagnosis" @submit="submitDiagnosis" />
        </main>
    </div>
</template>
