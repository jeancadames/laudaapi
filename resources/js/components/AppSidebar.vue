...
const tenantMode = computed(() => String(tenantAccess.value?.mode ?? 'subscriber.user'));
...
const tenantAdminMain: NavItem[] = mapToNavItems(navigationByRole.subscriber_admin.main);
...
<template>
    ...
    >
        <SidebarHeader>
                    ...
                    <SidebarMenuButton size="lg" as-child class="h-auto py-2">
                        ...
                        >
                            ...
                            <div class="flex min-w-0 flex-1 flex-col leading-tight group-data-[collapsible=icon]:hidden">
                                ...
                                <span class="truncate text-[8px] font-bold tracking-[0.18em] text-red-400">
                                    {{ brandCaption }}
                                </span>
                            </div>
                        </Link>
            ...
            >
                <p class="text-[9px] font-bold tracking-[0.14em] text-white/35 uppercase">
                    Empresa activa
                </p>
                <p class="mt-1 wrap-break-words text-[11px] font-bold text-white/85">
                    {{ companyName }}
                </p>
                <p v-if="companySlug" class="mt-0.5 truncate text-[9px] text-white/45">
                    {{ companySlug }}
                </p>
